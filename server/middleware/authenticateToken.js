...
const authenticateTokenCookie = (req, res, next) => {
  ...
  function handleVerificationResult(err, decoded) {
    ...
    if (err) {
      ...
      //!If the token verification is successful, this line sets the decoded payload as the student property of the req object. This allows you to access the decoded student information in subsequent middleware or route handlers.
      req.student = decoded;
      console.log();
